...
public class ExampleMain {
    ...
    private void run() throws SQLException, ClassNotFoundException {
        ...
        Connection connection = DriverManager.getConnection("jdbc:mysql://database-1.czezznnjq1kk.us-east-1.rds.amazonaws.com/Cloudsmith?user=admin&password=ayushmanyan&zeroDateTimeBehavior=convertToNull");
